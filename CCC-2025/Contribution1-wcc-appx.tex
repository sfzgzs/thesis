...
\begin{frame}{Challenges - \WhileCC-approximability Theorem}
    \begin{minipage}[t]{0.43\linewidth}
        ...
        \begin{exampleblock}{\textbf{Solution}}
            \begin{itemize}
                \item Find an overlapping interval where both pieces are defined
                \item Use the nondeterminism of ``choose''  
            \end{itemize}
            \pause
            {\textbf{\color{OliveGreen}Example: Even Root}\\}
            {
                % \footnotesize
                \pause
    ...
    \begin{minipage}[t]{0.55\linewidth}
        \vspace{-2em}
        \pause
        \includegraphics[width=.98\linewidth]{even-root.png}
    \end{minipage}
